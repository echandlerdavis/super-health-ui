...
//  * @param setToastData the setter
// function that sets the data to be displayed in the toast component
...
// (' ** AND ** ', constants.PRODUCT_FORM_INVALID_QUANTITY);
//       } else {
...
//     <section>
//       <h2>New Product</h2>
//       {formHasError.current && <AppAlert severity="error"
// title="Error" message={formErrorMessage} />}
